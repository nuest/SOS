...
public class RasdamanSessionFactoryProvider extends SessionFactoryProvider {
	...
	protected Configuration getConfiguration(Properties properties)
		...
		Configuration config = super.getConfiguration(properties);
		config.registerTypeOverride(new HibernateGeometryType(), new String[] { "geometry", Geometry.class.getName() });
		return config;
	}
}
