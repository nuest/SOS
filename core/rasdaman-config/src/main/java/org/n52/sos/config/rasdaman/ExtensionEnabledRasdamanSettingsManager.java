...
import org.n52.sos.config.rasdaman.entities.OfferingExtensionIdentifier;
...
public class ExtensionEnabledRasdamanSettingsManager extends RasdamanSettingsManager implements CapabilitiesExtensionManager {
    private static final Logger LOGGER = LoggerFactory.getLogger(ExtensionEnabledRasdamanSettingsManager.class);
