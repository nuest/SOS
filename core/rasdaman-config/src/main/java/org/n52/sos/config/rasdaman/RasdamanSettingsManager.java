...
import org.n52.sos.config.rasdaman.entities.AbstractSettingValue;
import org.n52.sos.config.rasdaman.entities.Activatable;
...
import org.n52.sos.config.rasdaman.entities.ObservationEncodingKey;
import org.n52.sos.config.rasdaman.entities.Operation;
import org.n52.sos.config.rasdaman.entities.OperationKey;
import org.n52.sos.config.rasdaman.entities.ProcedureEncoding;
import org.n52.sos.config.rasdaman.entities.ProcedureEncodingKey;
...
public abstract class RasdamanSettingsManager extends AbstractSettingsManager {
    private static final Logger LOG = LoggerFactory.getLogger(RasdamanSettingsManager.class);

    private static final Pattern SETTINGS_TYPE_CHANGED = Pattern
            .compile(".*Abort due to constraint violation \\(column .* is not unique\\)");

    public static final SettingValueFactory RASDAMAN_SETTING_FACTORY = new RasdamanSettingFactory();

    private ConnectionProvider connectionProvider;

    public RasdamanSettingsManager() throws ConfigurationException {
        super();
    }
    ...
    protected ConnectionProvider createDefaultConnectionProvider() {
        return new RasdamanSessionFactory();
    }
    ...
    public SettingValueFactory getSettingFactory() {
        return RASDAMAN_SETTING_FACTORY;
    }
    ...
    private static class RasdamanSettingFactory extends AbstractSettingValueFactory {
        @Override
